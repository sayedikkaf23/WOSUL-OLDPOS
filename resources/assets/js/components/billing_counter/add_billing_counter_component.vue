            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="billing_counter_code" v-model="billing_counter_code" v-validate="'required|alpha_dash|max:30'" class="form-control form-control-custom" :placeholder="enter_counter_code"  autocomplete="off">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="billing_counter_name" v-model="billing_counter_name" v-validate="'required|max:150'" class="form-control form-control-custom" :placeholder="enter_counter_name"  autocomplete="off">
    ...
    export default {
        data(){
            return{
                ...
                status          : (this.billing_counter_data == null)?'1':(this.billing_counter_data.status == null)?'':this.billing_counter_data.status.value,
                enter_counter_code:this.$t("Please enter counter code"),
                enter_counter_name:this.$t("Please enter counter name"),
