        ...
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                ...
                <div class="ml-auto">
                    ...
                    <button type="submit" class="btn btn-danger" v-if="delete_register_access == true && business_register.closing_date != null" v-on:click="delete_register()" v-bind:disabled="delete_processing == true"> <i class='fa fa-circle-notch fa-spin'  v-if="delete_processing == true"></i> {{ $t('Delete Register') }}</button>
          ...
          <div class="form-row mb-2">
            ...
            <div class="form-group col-md-3">
              <label for="closing_amount">{{ $t("Closing Cash Amount") }}</label>
              <p>{{ business_register.cash  }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="credit_card_slips">{{ $t("Expected Cash Amount") }}</label>
              <p>{{ business_register.expected_cash_amount }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="cheques">{{ $t("Variance Cash") }}</label>
              <p>{{ business_register.variance_cash }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="cheques">{{ $t("Closing Credit Amount") }}</label>
              <p>{{ business_register.credit }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="cheques">{{ $t("Expected Credit Amount") }}</label>
              <p>{{ business_register.expected_credit_amount }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="cheques">{{ $t("Variance Credit") }}</label>
              <p>{{ business_register.variance_credit }}</p>
            </div>
            <div class="form-group col-md-3">
              <label for="cheques">{{ $t("Manual Drawer Opens") }}</label>
              <p>{{ business_register.manual_drawer_opens }}</p>
            </div>
          </div>
