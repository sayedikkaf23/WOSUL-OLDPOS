    ...
    <div class="row">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="account_name" v-model="account_name" v-validate="'required|max:250'" class="form-control form-control-custom" :placeholder="enter_account_name"  autocomplete="off">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="account_type" v-model="account_type" v-validate="'required'" class="form-control form-control-custom custom-select">
                            <option value="">{{ $t('Choose Account Type..') }}</option>
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name="initial_balance" v-model="initial_balance" v-validate="'required|decimal|min_value:0'" class="form-control form-control-custom" :placeholder="enter_initial_balance"  autocomplete="off">
        ...
        <modalcomponent v-if="show_modal" v-on:close="show_modal = false">
            ...
            <template v-slot:modal-body>
                <p v-if="status == 0">{{ $t('If account is inactive all the transactions will get affected.') }}</p>
    ...
    export default {
        data(){
            return{
                ...
                status          : (this.account_data == null)?'1':(this.account_data.status == null)?'':this.account_data.status.value,
                enter_account_name:this.$t('Please enter account name'),
                enter_initial_balance:this.$t('Please enter initial balance'),
