    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                ...
                <div class="">
                    <span v-bind:class="stock_transfer.status.color">{{ $t(stock_transfer.status.label) }}</span>
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap mb-4" >
                ...
                <div class="ml-auto">
                    <button type="button" class="btn btn-info mr-1" v-on:click="print()"> {{ $t("Print") }}</button>
            ...
            <div class="mb-2 print">
                <span class="text-subhead">{{ $t("Product Information") }}</span>
            </div>
            <div class="table-responsive mb-2 print">
                <table class="table table-striped table-bordered display nowrap text-nowrap w-100">
                    ...
                    <tbody>
                        <tr v-for="(stock_transfer_product, key, index) in products" v-bind:value="stock_transfer_product.product_slack" v-bind:key="index">
                            ...
                            <td><span v-bind:class="stock_transfer_product.status.color"> {{ $t(stock_transfer_product.status.label) }}</span></td>
