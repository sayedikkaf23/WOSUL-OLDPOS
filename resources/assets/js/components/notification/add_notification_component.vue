    ...
    <div class="row">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <cool-select type="text" v-model="search_user"  autocomplete="off" inputForTextClass="form-control form-control-custom" :items="user_list" item-text="label" itemValue='label' :resetSearchOnBlur="false" disable-filtering-by-search @search='load_users' @select='add_user_to_list' :placeholder="choose_users">
                            <template #item="{ item }">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-6">
                        ...
                        <textarea name="notification" v-model="notification" v-validate="'required|max:65535'" class="form-control form-control-custom" rows="5" :placeholder="enter_notification"></textarea>
        ...
        <modalcomponent v-if="show_modal" v-on:close="show_modal = false">
            ...
            <template v-slot:modal-body>
                <p class="display-block" v-show="role !='' && users.length == 0">{{ $t('Note : All the users with selected role will be notified') }}</p>
    ...
    export default {
        data(){
            return{
                ...
                search_user     : '',
                choose_users:this.$t('Choose users..'),
                enter_notification:this.$t('Enter Notification'),
