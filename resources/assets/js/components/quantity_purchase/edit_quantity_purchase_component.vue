    ...
    <div class="col-md-12">
      <form @submit.prevent="submit_form" class="mb-3">
        <div class="d-flex flex-wrap mb-4">
          <div class="mr-auto">
            <span class="text-title" v-if="purchase_order_slack == ''">{{
        ...
        <div class="form-row mb-2">
          <div class="form-group col-md-3">
            ...
            <cool-select
              ...
              :placeholder="search_supplier_placeholder"
              autocomplete="off"
              v-model="supplier"
              :items="supplier_list"
              item-text="label"
        ...
        <div class="form-row mb-2">
          <div class="form-group col-md-3">
            ...
            <input
              ...
              :placeholder="search_po_placeholder"
              autocomplete="off"
            />
            <span v-bind:class="{ error: errors.has('po_number') }">{{
          ...
          <div class="form-group col-md-3">
            ...
            <input
              ...
              v-validate="'max:30'"
              class="form-control form-control-custom"
              :placeholder="search_por_placeholder"
              autocomplete="off"
            />
            <span v-bind:class="{ error: errors.has('po_reference') }">{{
              errors.first("po_reference")
            }}</span>
          </div>
          <div class="form-group col-md-3">
            ...
            <date-picker
              ...
              ref="order_date"
              name="order_date"
              :placeholder="search_order_date_placeholder"
              autocomplete="off"
            ></date-picker>
            <span v-bind:class="{ error: errors.has('order_date') }">{{
          ...
          <div class="form-group col-md-3">
            ...
            <date-picker
              ...
              v-validate="'date_format:yyyy-MM-dd'"
              input-class="form-control form-control-custom bg-white"
              :placeholder="search_due_date_placeholder"
              autocomplete="off"
            ></date-picker>
        ...
        <div class="form-row mb-2">
          ...
          <div class="form-group col-md-3">
            ...
            <select class="form-control" v-model="discount_type" disabled>
              <option value="1" selected="">Amount</option>
              <option value="2">In Percentage(%)</option>
            </select>
            <span v-bind:class="{ error: errors.has('tax_option') }">{{
          ...
          <div class="form-group col-md-3">
            ...
            <input
              ...
              v-validate="'max:30'"
              class="form-control form-control-custom"
              :placeholder="search_discount_placeholder"
              autocomplete="off"
              readonly="true"
            />
            <span v-bind:class="{ error: errors.has('discount_rate') }">{{
        ...
        <div class="form-row mb-2">
          <div class="form-group col-md-6">
            <div class="custom-control custom-switch">
              ...
              />
              <label class="custom-control-label" for="update_stock_switch">{{
                $t("Update Product Stock")
              }}</label>
              <small class="form-text text-muted">{{ $t("If this option is enabled, product stock will be updated when the purchase order is closed") }} .</small>
            </div>
          </div>
        </div>
        ...
        <div class="form-row mb-2">
          <div class="form-group col-md-4">
            ...
            <cool-select
              ...
              @select="add_product_to_list"
              :placeholder="search_typing_placeholder"
            ></cool-select>
          </div>
        </div>
        ...
        <div class="form-row mb-3">
          ...
          <div class="col-md-2">
            ...
            />
            <span
              v-bind:class="{ error: errors.has('total_discount_amount') }"
              >{{ errors.first("total_discount_amount") }}</span
            >
          </div>
        </div>
        <div class="form-row mb-3">
          ...
          <div class="col-md-2">
            <input
              ...
              readonly="true"
            />
            <span v-bind:class="{ error: errors.has('total_tax_amount') }">{{
              errors.first("total_tax_amount")
            }}</span>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      show_modal: false,
      api_link:
        this.purchase_order_data == null
          ? "/api/add_purchase_order"
          : "/api/update_purchase_order/" + this.purchase_order_data.slack,
      ...
      supplier_name:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.supplier.supplier_code +
            " - " +
            this.purchase_order_data.supplier.name,
      purchase_order_slack:
        this.purchase_order_data == null ? "" : this.purchase_order_data.slack,
      po_number:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.po_number != null
      ...
      update_stock:
        this.purchase_order_data == null
          ? false
          : this.purchase_order_data.update_stock != null
          ? this.purchase_order_data.update_stock == 1
            ? true
            : false
          : false,
      ...
      shipping_charge:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.shipping_charge != null
          ? this.purchase_order_data.shipping_charge
          : "",
      packing_charge:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.packing_charge != null
          ? this.purchase_order_data.packing_charge
          : "",
      terms:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.terms != null
          ? this.purchase_order_data.terms
          : "",
      grand_total: 0,
      total_tax_amount:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.total_tax_amount,
      total_discount_amount:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.total_discount_amount,
      store_tax_percentage:
        this.store_tax_percentage == null ? "" : this.store_tax_percentage,
      discount_type:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.discount_type,
      discount_rate:
        this.purchase_order_data == null
          ? ""
          : this.purchase_order_data.discount_rate,
      ...
      po_product_list:
        this.purchase_order_data != null
          ? this.purchase_order_data.products
          : [],
