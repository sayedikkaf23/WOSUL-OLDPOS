            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <date-picker :format="date.format" :lang='date.lang' v-model="transaction_date" v-validate="'required|date_format:yyyy-MM-dd'" input-class="form-control form-control-custom bg-white" ref="transaction_date" name="transaction_date" :placeholder="enter_transaction_date" autocomplete="off"></date-picker>
                    ...
                    <div class="form-group col-md-3">
                        <label for="bill_to_slack">{{ $t("Choose Customer or Supplier") }} <button type="button" class="btn btn-sm btn-secondary" @click="addSupplier()" v-if="bill_to == 'SUPPLIER'" >+</button> <button type="button" class="btn btn-sm btn-secondary" @click="addCustomer()" v-if="bill_to == 'CUSTOMER'" >+</button> </label>
                        <select class="form-control" v-model="bill_to_slack">
                          <option value="">{{$t('--Choose Customer or Supplier--')}}</option>
                          <option v-if="bill_to == 'SUPPLIER'" value="DEFAULT">DEFAULT</option>
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='amount' v-model="amount" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="enter_the_amount"  autocomplete="off" step="0.01" min="0">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <textarea name="notes" v-model="notes" v-validate="'max:65535'" class="form-control form-control-custom" rows="5" :placeholder="enter_notes"></textarea>
