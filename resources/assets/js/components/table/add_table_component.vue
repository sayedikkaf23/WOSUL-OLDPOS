            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="table_number" v-model="table_number" v-validate="'required|max:250'" class="form-control form-control-custom" :placeholder="enter_table_name"  autocomplete="off">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='no_of_occupants' v-model="no_of_occupants" v-validate="'required|numeric'" class="form-control form-control-custom" :placeholder="enter_no_occupants"  autocomplete="off" step="1" min="0">
    ...
    export default {
        data(){
            return{
                ...
                status       : (this.table_data == null)?'1':(this.table_data.status == null)?'':this.table_data.status.value,
                enter_table_name:this.$t('Please enter table name'),
                enter_no_occupants:this.$t('Please enter no of occupants'),
