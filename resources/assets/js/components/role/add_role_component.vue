  ...
  <div class="row">
    <div class="col-md-12">
      <form @submit.prevent="submit_form" class="mb-3">
        <div class="d-flex flex-wrap mb-4">
          <div class="mr-auto">
            <span class="text-title" v-if="role_slack == ''">{{
              $t("Add Role")
            }}</span>
        ...
        <div class="form-row mb-2">
          <div class="form-group col-md-3">
            ...
            <input
              ...
              autocomplete="off"
            />
            <span v-bind:class="{ error: errors.has('role') }">{{
              errors.first("role")
            }}</span>
          </div>
          <div class="form-group col-md-3">
            ...
            <div class="mb-2">
              ...
              >
                ...
                <label
                  ...
                  v-bind:for="submenu_item.menu_key"
                >
                ...
                <div class="mb-2">
                  <div
                    ...
                    v-for="(action_item, index) in submenu_item.actions"
                    v-bind:key="index"
                  >
                    <input
                      class="custom-control-input"
                    ...
                    <label
                      class="custom-control-label"
                      v-bind:for="action_item.menu_key"
                    >
                      {{ $t(action_item.label) }}
                    </label>
                  </div>
    ...
    <modalcomponent v-if="show_modal" v-on:close="show_modal = false">
      ...
      <template v-slot:modal-body>
        <p v-if="status == 0">
          {{$t('If role is inactive all the users with this role will lose access to the system.')}}
        </p>
  ...
  methods: {
    ...
    menu_checker(payload) {
      if (payload.event.target.checked == true) {
        ...
        if (payload.type == "ACTIONS") {
          this.menu_selected = this.array_remove(
            this.menu_selected,
            payload.current
          );
