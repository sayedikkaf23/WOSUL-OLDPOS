            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div v-bind:class="[reload_on_submit ? 'col-md-3' : 'col-md-12', 'form-group']">
                        ...
                        <input type="text" name="unit_code" v-model="unit_code" v-validate="'required|alpha_dash|max:30'" class="form-control form-control-custom" :placeholder="unit_placeholder"  autocomplete="off">
...
<script>
    ...
    export default {
        data(){
           ...
           unit_placeholder: this.$t("Please enter unit code"),
           label_placeholder: this.$t("Please enter label"),
                ...
                status : (this.measurement_unit_data == null)?'1':(this.measurement_unit_data.status == null)?'':this.measurement_unit_data.status.value,
