        ...
        <div class="container-lg">
            <div class="col-md-12 pt-4">
                ...
                <div class="d-flex justify-content-between mb-5">
                    <div>
                        <img :src="getLogoUrl(order_basic.store.store_logo, company_logo)" class="company_logo">   
                    </div>
                    <div>
                            ...
                            <div class="mr-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-3 align-self-center customer">
                                        ...
                                        <div class="d-block"> 
                                            <span class="d-block text-left" v-if="order_basic.customer_email != 'walkingcustomer@wosul.sa'">Email : {{ (order_basic.customer_email == null)?'-':order_basic.customer_email }} </span>
                ...
                <div class="d-flex justify-content-center mb-5">
                    Powered by <img src="/theme/images/logo.jpg" class="powered-by ml-2">
                </div>
    ...
    export default {
        data(){
            return{
                ...
                store_logo      : this.order_data.store.store_logo,
            }
        },
        props: {
        ...
        methods: {
           getLogoUrl: function(store_image, company_image) {
              let src = company_image;
              console.log(store_image);
              if (store_image != '') {
                 console.log('in');
                 src = "/storage/store/" + store_image ;
              }
