            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <date-picker type="month" :lang='date.lang' :format="date.format" name="month_raw" v-model="month_raw" v-validate="'required'" @change="target_month_change" input-class="form-control bg-white" :placeholder="select_month"></date-picker>
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='income' v-model="income" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="enter_income"  autocomplete="off" step="0.01" min="0">
                        <span v-bind:class="{ 'error' : errors.has('income') }">{{ errors.first('income') }}</span> 
                    </div>
                    <div class="form-group col-md-3">
                        <label for="expense">{{ $t("Expense") }} ({{ store.currency_code }})</label>
                        <input type="number" name='expense' v-model="expense" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="enter_expense"  autocomplete="off" step="0.01" min="0">
                        <span v-bind:class="{ 'error' : errors.has('expense') }">{{ errors.first('expense') }}</span> 
                    </div>
                    <div class="form-group col-md-3">
                        <label for="sales">{{ $t("Sales") }} ({{ store.currency_code }})</label>
                        <input type="number" name='sales' v-model="sales" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="enter_sales"  autocomplete="off" step="0.01" min="0">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='net_profit' v-model="net_profit" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="enter_net_profit"  autocomplete="off" step="0.01" min="0">
    ...
    export default {
        data(){
            return{
                ...
                select_month:this.$t('Select month'),
                enter_income:this.$t('Please enter income'),
                enter_expense:this.$t('Please enter expense'),
                enter_sales:this.$t('Please enter sales'),
                enter_net_profit:this.$t('Please enter net profit'),
