                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown mr-1" v-if="templates.length != 0">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                                <a :href="template.template_link" class="dropdown-item" v-for="(template, index) in templates" :key="index" >{{ $t(template.template_label) }} {{ $t("Template") }}</a>
                            </div>
                        </div>
