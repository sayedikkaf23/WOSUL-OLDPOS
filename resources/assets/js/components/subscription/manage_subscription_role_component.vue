        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="d-flex flex-wrap mb-4">
                    <div class="mr-auto">
                        <span class="text-title">{{ $t("Manage Subscription Roles") }}</span>
                    </div>
                </div>
                ...
                <div class="mb-2">
                    <div class="custom-control custom-checkbox mb-3" v-for="(menu, index) in menus" v-bind:key="index">
                        ...
                        <label class="custom-control-label text-primary" v-bind:for="menu.menu_key">
    ...
    export default {
        data(){
            return{
                ...
                modal           : false,
                show_modal      : false,
                api_link        : (this.role_data == null)?'/api/add_role':'/api/update_subscription_role/'+this.role_data.slack,

                role_slack      : (this.role_data == null)?'':this.role_data.slack,
                role            : (this.role_data == null)?'':this.role_data.title,
                status          : 1,
        ...
        mounted() {
            console.log('Add subscription role page loaded');
        },
        methods: {
