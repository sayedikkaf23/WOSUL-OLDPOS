<template>
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right notification-dropdown pt-3 pb-3" aria-labelledby="notification_dropdown">
            ...
            <a class="dropdown-item notification-dropdown-item border-bottom" v-for="(notifications_list_item, index) in notifications_list" v-bind:value="notifications_list_item.slack" v-bind:key="index" v-bind:href="notifications_list_item.detail_link">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <small class="d-block text-muted">{{ notifications_list_item.created_by.fullname }} &middot; {{ notifications_list_item.created_at_label }}</small>
                    </div>
                </div>
            </a>
