...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="d-flex flex-wrap mb-4">
            <div class="mr-auto">
                <span class="text-title">{{ __("Discount") }}</span>
            </div>
            <div class="">
                @if (check_access(array('A_ADD_DISCOUNTCODE'), true))
                    <a href="{{ route('add_discount_code')}}" role="button" class="btn btn-primary">{{ __("New Discount") }}</a>
                @endif
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        discountcodes.load_listing_table(commonDatatablesData);
    </script>
@endpush