    ...
    <div id="invoice-wrapper">
        <div class="invoice-inner">
            <div class="header text-center">
                <img src="{{URL::asset('images/subscription-invoice-logo.png')}}" alt="Image" title="Image" />
            </div>
            ...
            <div class="list-items-details mt-1">
                <table>
                    ...
                    <tr>
                        ...
                        <th class="nowrap">
                            End Date<br /><span>المبلغ الخاضع للضريبة </span>
                        </th>
                        <th class="nowrap">Price<br /><span>الخصم</span></th>
                        <th class="nowrap">
                            Price Including Tax<br /><span>نسبة الضريبة </span>
                        </th>
                    </tr>
            ...
            <div class="delivery-address-details mt-1">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="direction-rtl">حالة الفوترة</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="direction-rtl">شارع الفواتير</td>
                    </tr>
                </table>
            </div>
