        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="top-header">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ url('/en/about')}}">
                    ...
                    <div class="fly-content-area col-md-12 col-sm-12">
                        <div>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-7 about-us-inner-content">
                                  

                                    <h5 class="font-arabic">نظام إدارة البيع بالتجزئة الشامل وصول على السحابة متاح على جهاز كمبيوتر مكتبي ، الجهاز اللوحي ، كمبيوتر محمول باللغتين الإنجليزية والعربية.</h5>

                                    <h5 class="font-arabic"> تقدم وصول نظام إدارة البيع بالتجزئة الشامل مع العديد </h5>

                                    <h5 class="font-arabic"> ، تطبيقات  في السحابة.</h5>
                        ...
                        <div class="fly-col-inner">
                            <div class="post-list">                                
                                <!-- Post 1 -->
                                <article class="post post-thumbnail-left clearfix">
                                    <div class="fly-post-content">
                                        <header class="entry-header">
                                            <h2 class="entry-title">
                                                <span hidefocus="true" style="outline: none;">نظام إدارة البيع بالتجزئة القائم على السحابة</span>
                                            </h2>
                                        </header>
                                        <div class="entry-content">تسجيل الدخول في أي مكان 
                                        </div>
                                        <button class="page-btn3">للمزيد</button>
                                    </div>
                                    <div class="fly-post-content">
                                        <header class="entry-header about-padding" \="">
                                            <h2 class="entry-title">
                                                <span hidefocus="true" style="outline: none;">قبول المدفوعات</span>
                                            </h2>
                                        </header>
                                        <div class="entry-content about-padding">تعمل وصول مع مقدمي الخدمات الرائده عالميا 
                                        </div>
                                        <button class="page-btn3 about-margin">للمزيد</button>
                                    </div>
                                </article>
                                <!-- Post 2 -->
                                <article class="post post-thumbnail-left clearfix">
                                    <div class="fly-post-content">
                                        <header class="entry-header">
                                            <h2 class="entry-title">
                                                <span hidefocus="true" style="outline: none;">يعمل على أجهزة الكمبيوتر الشخصية وأجهزة iPad و Android</span>
                                            </h2>
                                        </header>
                                        <div class="entry-content"> نقطة بيع تعمل بشكل كامل على جهاز iPad أو Android.  
                                        </div>
                                        <button class="page-btn3">للمزيد</button>
                                    </div>
                                    <div class="fly-post-content">
                                        <header class="entry-header">
                                            <h2 class="entry-title">
                                                <span class="about-padding" hidefocus="true" style="outline: none;">وضع غير متصل بالشبكة</span>
                                            </h2>
                                        </header>
                                        <div class="entry-content about-padding">استمر في البيع حتى عندما يتعطل الإنترنت. 
                                        </div>
                                        <button class="page-btn3 about-margin">للمزيد</button>
                                    </div>
                                </article>
