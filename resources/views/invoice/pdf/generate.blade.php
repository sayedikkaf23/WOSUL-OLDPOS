@php 
    ...
    if(@print_logo_path && @print_logo_path != ""){
...
<head>
    ...
    <link rel="stylesheet" href="http://demo.wosul.test/plugins/bootstrap/bootstrap.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    <script src="http://demo.wosul.test/plugins/bootstrap/bootstrap.min.js"></script>
</head>
