        ...
        <div class="d-flex flex-wrap mb-4">
            ...
            <div class="">
                @if (check_access(array('A_ADD_COMBO_GROUP'), true))
                    <a href="{{ route('add_combo_group')}}" role="button" class="btn btn-primary">{{ __("New Group") }}</a>
                @endif
            </div>
        </div>
