<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
        {{-- @if (check_access(array('A_DETAIL_TAXCODE'), true))
            <a href="{{ $combo_code['detail_link'] }}" class="dropdown-item">{{ __("View") }}</a>
        @endif --}}
        @if (check_access(array('A_EDIT_COMBO'), true))
            <a href="edit_combo/{{ $combo['slack'] }}" class="dropdown-item">{{ __("View/Edit") }}</a>
        @endif
    </div>
</div>