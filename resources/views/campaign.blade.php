...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-DHHGYPHWVW"></script>
    <script>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="phonumber-field-group">
                                        ...
                                        <div class="phonumber-field-input">
                                            <input type="text" placeholder="05xxxxxxxx" class="form-control"
                                ...
                                <div class="form-submit-wrap">
                                    <div class="row col-12">
                                        <div class="col-4">
                                            <input type="hidden" id="demo_request_pt" value="{{ request('pt') }}" >
                                            <button type="button" class="btn btn-primary btn-m-width disabled btn-submit"
                                                onclick="submit_campaign()">{{ __('Submit') }}</button>
                                        </div>
                                        {{-- <div class="col-4">
                                            <button type="button" style="display: none;"  class="btn btn-info btn-m-width btn-reload "
                                                onclick="window.location.reload()">{{ __('Reload') }}</button>
                                        </div> --}}
                                    </div>
                                </div>
                            </form>
...
-->
    ...
    <script type="text/javascript">
        ...
        function submit_campaign() {
            ...
            formData.append('pt', $('#demo_request_pt').val());

            $.ajax({
                url: "{{ route('save_campaign') }}",
                type: 'POST',
                processData: false,
                contentType: false,
                dataType: 'json',
