...
class User extends Controller
{
    ...
    public function add_user(Request $request, $slack = null){
        ...
        if(isset($slack)){
            ...
            $data['is_master_status'] = $user_data['is_master'];
        ...
        $data['all_available_stores'] = StoreModel::select('slack as store_slack')
        ->active()->pluck('store_slack')->toArray();
