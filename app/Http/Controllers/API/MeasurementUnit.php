...
class MeasurementUnit extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data['action_key'] = 'A_VIEW_MEASUREMENT_UNIT';
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (!empty($measurement_unit_data_exists)) {
                throw new Exception(trans("Measurement unit already exists"), 400);
            }
    ...
    public function update(Request $request, $slack)
    {
        try {
            ...
            return response()->json($this->generate_response(
                array(
                    "message" => trans("Measurement unit updated successfully"), 
                    "data"    => $slack
                ), 'SUCCESS'
            ));
