...
class BillingCounter extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (!empty($billing_counter_code_data_exists)) {
                throw new Exception(trans("Billing counter code already exists"), 400);
            }
            ...
            if (!empty($billing_counter_data_exists)) {
                throw new Exception(trans("Billing counter name already exists"), 400);
            }
            ...
            return response()->json($this->generate_response(
                array(
                    "message" => trans("Billing counter created successfully"), 
    ...
    public function list(Request $request)
    {
        try {
            ...
            return response()->json($this->generate_response(
                array(
                    "message" => trans("Billing Counter loaded successfully"), 
                    "data"    => $list
                ), 'SUCCESS'
            ));
    ...
    public function update(Request $request, $slack)
    {
        try {
            ...
            return response()->json($this->generate_response(
                array(
                    "message" => trans("Billing counter updated successfully"), 
                    "data"    => $slack
                ), 'SUCCESS'
            ));
