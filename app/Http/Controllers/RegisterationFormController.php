...
class RegisterationFormController extends Controller
{
    ...
    public function response()
    {
        ...
        $data['registration_form_results'] = RegistrationForm::where('type',1)->orderBy('id', 'DESC')->get();
        return view('registration_form-response', compact('data'));
    }
