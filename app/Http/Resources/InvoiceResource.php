...
class InvoiceResource extends Resource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'customer' => ($this->bill_to == "CUSTOMER"||$this->bill_to == "COMPANY")?new CustomerResource($this->customer):'',
            'currency_name' => $this->currency_name,
            'currency_code' => $this->currency_code,
            'subtotal_excluding_tax' => $this->subtotal_excluding_tax,
            'subtotal_including_tax' => $this->subtotal_including_tax,
            ...
            'expresspay_transactions' => $this->expresspay_transactions,
        ];
    }
}
