...
class OrderListByDateProducts extends Resource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'return_quantity'=>(string)$returned_quantity,
            'name' => $this->name,
            ...
            'order_quantity' => (string)$this->quantity,
            'pending_quantity' => (string)((int)$this->quantity-(int)$returned_quantity),
