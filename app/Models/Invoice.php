...
class Invoice extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'invoice_number', 'invoice_reference', 'invoice_date', 'invoice_due_date', 'bill_to', 'bill_to_id', 'bill_to_code', 'bill_to_name', 'bill_to_email', 'bill_to_contact', 'bill_to_address', 'currency_name', 'currency_code', 'tax_option_id', 'subtotal_excluding_tax','subtotal_including_tax', 'total_discount_amount', 'total_after_discount', 'total_tax_amount', 'shipping_charge', 'packing_charge', 'total_order_amount', 'notes', 'terms', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at','invoice_color_code','return_invoice_amount'];
    ...
    public function expresspay_transactions(){
        return $this->hasMany('App\Models\Expresspay', 'bill_to_id', 'id')->where('expresspay.bill_to', 'INVOICE')->orderBy('expresspay.id', 'desc');
    }
