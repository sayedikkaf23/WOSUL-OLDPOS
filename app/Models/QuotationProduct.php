...
class QuotationProduct extends Model
{
    ...
    protected $hidden = ['id', 'quotation_id'];
    protected $fillable = ['slack', 'quotation_id', 'product_id', 'product_slack', 'product_code', 'name', 'description', 'show_description_in', 'quantity', 'amount_excluding_tax', 'subtotal_amount_excluding_tax', 'discount_percentage', 'tax_percentage', 'discount_amount', 'total_after_discount', 'tax_amount', 'tax_components',  'total_amount', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at','product_type'];
