...
class User extends Model
{
    ...
    protected $fillable = ['slack', 'user_code', 'fullname', 'email', 'password', 'login_code', 'init_password', 'phone', 'profile_image', 'role_id', 'status', 'created_by', 'updated_by','is_admin','is_master','is_cashier'];
    ...
    public function scopeStoreJoin($query){
