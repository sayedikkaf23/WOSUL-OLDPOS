...
class Account extends Model
{
    ...
    public function scopeQoyodAccountJoin($query){
        return $query->leftJoin('qoyod_users_accounts', function ($join) {
            $join->on('qoyod_users_accounts.account_id', '=', 'accounts.id');
        });
    }
