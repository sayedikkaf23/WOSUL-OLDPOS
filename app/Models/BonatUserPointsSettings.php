...
class BonatUserPointsSettings extends Model
{
    protected $table = 'bonat_user_points_settings';
    protected $hidden = ['id'];
    protected $fillable = ['slack', 'bonat_merchant_id', 'merchant_id', 'status', 'is_verify', 'created_by', 'updated_by', 'created_at', 'updated_at'];
